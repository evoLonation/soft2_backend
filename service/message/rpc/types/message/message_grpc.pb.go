...
func (c *messageClient) CreateMessage(ctx context.Context, in *CreateMessageReq, opts ...grpc.CallOption) (*CreateMessageReply, error) {
	out := new(CreateMessageReply)
	err := c.cc.Invoke(ctx, "/message.Message/CreateMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMessageServer) CreateMessage(context.Context, *CreateMessageReq) (*CreateMessageReply, error) {
